...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new view.datechooser.Button();
        cmdTu = new view.datechooser.Button();
        cmdWe = new view.datechooser.Button();
        cmdTh = new view.datechooser.Button();
        cmdFr = new view.datechooser.Button();
        cmdSa = new view.datechooser.Button();
        cmdSu = new view.datechooser.Button();
        cmd1 = new view.datechooser.Button();
        cmd2 = new view.datechooser.Button();
        cmd3 = new view.datechooser.Button();
        cmd4 = new view.datechooser.Button();
        cmd5 = new view.datechooser.Button();
        cmd6 = new view.datechooser.Button();
        cmd7 = new view.datechooser.Button();
        cmd8 = new view.datechooser.Button();
        cmd9 = new view.datechooser.Button();
        cmd10 = new view.datechooser.Button();
        cmd11 = new view.datechooser.Button();
        cmd12 = new view.datechooser.Button();
        cmd13 = new view.datechooser.Button();
        cmd14 = new view.datechooser.Button();
        cmd15 = new view.datechooser.Button();
        cmd16 = new view.datechooser.Button();
        cmd17 = new view.datechooser.Button();
        cmd18 = new view.datechooser.Button();
        cmd19 = new view.datechooser.Button();
        cmd20 = new view.datechooser.Button();
        cmd21 = new view.datechooser.Button();
        cmd22 = new view.datechooser.Button();
        cmd23 = new view.datechooser.Button();
        cmd24 = new view.datechooser.Button();
        cmd25 = new view.datechooser.Button();
        cmd26 = new view.datechooser.Button();
        cmd27 = new view.datechooser.Button();
        cmd28 = new view.datechooser.Button();
        cmd29 = new view.datechooser.Button();
        cmd30 = new view.datechooser.Button();
        cmd31 = new view.datechooser.Button();
        cmd32 = new view.datechooser.Button();
        cmd33 = new view.datechooser.Button();
        cmd34 = new view.datechooser.Button();
        cmd35 = new view.datechooser.Button();
        cmd36 = new view.datechooser.Button();
        cmd37 = new view.datechooser.Button();
        cmd38 = new view.datechooser.Button();
        cmd39 = new view.datechooser.Button();
        cmd40 = new view.datechooser.Button();
    ...
    private view.datechooser.Button cmd1;
    private view.datechooser.Button cmd10;
    private view.datechooser.Button cmd11;
    private view.datechooser.Button cmd12;
    private view.datechooser.Button cmd13;
    private view.datechooser.Button cmd14;
    private view.datechooser.Button cmd15;
    private view.datechooser.Button cmd16;
    private view.datechooser.Button cmd17;
    private view.datechooser.Button cmd18;
    private view.datechooser.Button cmd19;
    private view.datechooser.Button cmd2;
    private view.datechooser.Button cmd20;
    private view.datechooser.Button cmd21;
    private view.datechooser.Button cmd22;
    private view.datechooser.Button cmd23;
    private view.datechooser.Button cmd24;
    private view.datechooser.Button cmd25;
    private view.datechooser.Button cmd26;
    private view.datechooser.Button cmd27;
    private view.datechooser.Button cmd28;
    private view.datechooser.Button cmd29;
    private view.datechooser.Button cmd3;
    private view.datechooser.Button cmd30;
    private view.datechooser.Button cmd31;
    private view.datechooser.Button cmd32;
    private view.datechooser.Button cmd33;
    private view.datechooser.Button cmd34;
    private view.datechooser.Button cmd35;
    private view.datechooser.Button cmd36;
    private view.datechooser.Button cmd37;
    private view.datechooser.Button cmd38;
    private view.datechooser.Button cmd39;
    private view.datechooser.Button cmd4;
    private view.datechooser.Button cmd40;
    private view.datechooser.Button cmd41;
    private view.datechooser.Button cmd42;
    private view.datechooser.Button cmd5;
    private view.datechooser.Button cmd6;
    private view.datechooser.Button cmd7;
    private view.datechooser.Button cmd8;
    private view.datechooser.Button cmd9;
    private view.datechooser.Button cmdFr;
    private view.datechooser.Button cmdMo;
    private view.datechooser.Button cmdSa;
    private view.datechooser.Button cmdSu;
    private view.datechooser.Button cmdTh;
    private view.datechooser.Button cmdTu;
    private view.datechooser.Button cmdWe;
