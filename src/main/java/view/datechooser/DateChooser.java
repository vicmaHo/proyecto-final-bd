...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new view.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new view.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new view.datechooser.Button();
        cmdPrevious = new view.datechooser.Button();
        slide = new view.datechooser.Slider();
        ...
        headerLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, headerLayout.createSequentialGroup()
                ...
                .addComponent(MY)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmdForward, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private view.datechooser.Button cmdForward;
    private view.datechooser.Button cmdMonth;
    private view.datechooser.Button cmdPrevious;
    private view.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private view.datechooser.Slider slide;
